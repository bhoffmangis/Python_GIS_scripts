...
for fc in fc_list:
    ...
    arcpy.AddField_management(fc, "Commercial_Closure_U", "TEXT", "", "", 3, "", "NULLABLE", "", "Update_Flag")
...
# Add default 'no' values to update/checked fields
    new_fields = ["Commercial_Closure_U", "Prohibit_Allow_Restrict_U", "type_U", "spp_U",
